...
class RoverState():
    def __init__(self):
        ...
        self.current_time = 0
        self.dist_sec_cnt = 0
        self.tot_sec = 0 # To count the total seconds
        self.dist = 0.0 # Distance traveled in 5 seconds
        self.stopped = False # Set to true once the rover is stoped while there is a rock sample in vision
        self.start_time = None # To record the start time of navigation
        self.total_time = None # To record total duration of naviagation
        self.img = None # Current camera image
        self.pos = [0.0, 0.0] # Current position (x, y)
